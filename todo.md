...
# Publicação
- [x] Resolver bloqueio: alterações locais ainda não aparecem no domínio publicado dermabrand.com.br.
- [x] Remover qualquer secret versionado antes de publicar no GitHub.
- [x] Garantir que o repositório correto receba as mudanças finais de estilo, prompt e relatório.
- [x] Verificar o domínio publicado após a publicação.


# Scores do Diagnóstico
- [x] Adicionar dois novos scores especialistas além do Score de Autoridade.
- [x] Ajustar o prompt da IA para considerar três notas: autoridade, bio/posicionamento e conteúdo/engajamento.
- [x] Atualizar o dashboard para exibir três scores de forma premium e clara.
- [ ] Publicar as alterações no GitHub e verificar o domínio dermabrand.com.br.
...
- [x] Validar sintaxe, publicar no GitHub e verificar o domínio dermabrand.com.br após o ajuste do placeholder.
...
- [x] Validar sintaxe, publicar no GitHub e verificar o domínio dermabrand.com.br após o ajuste do botão.
...
# Ajustes Mobile da Primeira Dobra
