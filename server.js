...
const SEASONAL_CALENDAR = [
  // Janeiro
  { month: 1, day: 1,  label: 'Ano Novo — Metas de Saúde', tags: ['bem-estar','saúde mental','nutrologia','endocrinologia','dermatologia'] },
  { month: 1, day: 11, label: 'Dia Mundial da Hipertensão Pulmonar', tags: ['cardiologia','pneumologia'] },
  { month: 1, day: 17, label: 'Dia Nacional de Combate à Hansenaníase', tags: ['dermatologia','infectologia','saúde pública'] },
  { month: 1, day: 20, label: 'Janeiro Branco — Saúde Mental e Emocional', tags: ['psiquiatria','psicologia','saúde mental','bem-estar'] },
  { month: 1, day: 22, label: 'Dia Nacional do Cego (Oftalmologia Preventiva)', tags: ['oftalmologia','saúde pública'] },
  // Fevereiro
  { month: 2, day: 4,  label: 'Dia Mundial do Câncer', tags: ['oncologia','dermatologia','ginecologia','urologia','mastologia'] },
  { month: 2, day: 14, label: 'Dia dos Namorados (EUA/Internacional)', tags: ['saúde sexual','ginecologia','urologia','dermatologia','bem-estar'] },
  { month: 2, day: 28, label: 'Dia das Doenças Raras', tags: ['genética','neurologia','reumatologia','saúde pública'] },
  // Março
  { month: 3, day: 8,  label: 'Dia Internacional da Mulher', tags: ['saúde feminina','ginecologia','mastologia','dermatologia','nutrição'] },
  { month: 3, day: 20, label: 'Dia Mundial da Felicidade', tags: ['saúde mental','psiquiatria','psicologia','bem-estar'] },
  { month: 3, day: 21, label: 'Dia Mundial da Síndrome de Down', tags: ['genética','neurologia','pediatria'] },
  { month: 3, day: 21, label: 'Início do Outono', tags: ['dermatologia','nutrição','imunologia','bem-estar'] },
  { month: 3, day: 24, label: 'Dia Mundial da Tuberculose', tags: ['infectologia','pneumologia','saúde pública'] },
  { month: 3, day: 26, label: 'Dia Nacional de Prevenção e Combate à Hipertensão', tags: ['cardiologia','clínica médica','nutrição'] },
  // Abril
  { month: 4, day: 2,  label: 'Dia Mundial do Autismo (Abril Azul)', tags: ['neurologia','pediatria','psiquiatria','psicologia'] },
  { month: 4, day: 7,  label: 'Dia Mundial da Saúde', tags: ['saúde pública','prevenção','todos os especialistas'] },
  { month: 4, day: 17, label: 'Dia Nacional de Combate à Hipertensão', tags: ['cardiologia','clínica médica','nutrição'] },
  { month: 4, day: 22, label: 'Dia da Terra (Saúde e Meio Ambiente)', tags: ['saúde ambiental','nutrição','bem-estar'] },
  { month: 4, day: 28, label: 'Dia Mundial da Saúde e Segurança no Trabalho', tags: ['medicina do trabalho','ortopedia','saúde mental'] },
  // Maio
  { month: 5, day: 1,  label: 'Maio Amarelo — Saúde Mental no Trabalho', tags: ['saúde mental','psiquiatria','psicologia','bem-estar'] },
  { month: 5, day: 11, label: 'Dia Nacional de Prevenção da Obesidade', tags: ['endocrinologia','nutrologia','cirurgia bariátrica','nutrição'] },
  { month: 5, day: 12, label: 'Dia das Mães', tags: ['saúde feminina','ginecologia','dermatologia','nutrição','bem-estar'] },
  { month: 5, day: 15, label: 'Dia da Família (Saúde Familiar)', tags: ['pediatria','clínica médica','nutrição','saúde pública'] },
  { month: 5, day: 17, label: 'Dia Mundial da Hipertensão', tags: ['cardiologia','clínica médica','nutrição','nefrologia'] },
  { month: 5, day: 19, label: 'Dia Nacional de Combate à Hepatite', tags: ['gastroenterologia','infectologia','hepatologia'] },
  { month: 5, day: 25, label: 'Dia Nacional de Prevenção da Hipertensão', tags: ['cardiologia','nutrição'] },
  { month: 5, day: 28, label: 'Dia Internacional da Saúde da Mulher', tags: ['ginecologia','saúde feminina','mastologia','endocrinologia'] },
  { month: 5, day: 31, label: 'Dia Mundial Sem Tabaco', tags: ['pneumologia','cardiologia','oncologia','dermatologia'] },
  // Junho
  { month: 6, day: 5,  label: 'Dia Mundial do Meio Ambiente', tags: ['saúde ambiental','nutrição','bem-estar'] },
  { month: 6, day: 12, label: 'Dia dos Namorados (Brasil)', tags: ['saúde sexual','dermatologia','ginecologia','urologia','bem-estar'] },
  { month: 6, day: 13, label: 'Festa Junina (Inverno Brasileiro)', tags: ['nutrição','endocrinologia','dermatologia','saúde digestiva'] },
  { month: 6, day: 21, label: 'Início do Inverno', tags: ['dermatologia','pneumologia','imunologia','nutrição','reumatologia','ortopedia'] },
  ...
  { month: 7, day: 14, label: 'Dia Nacional de Prevenção e Controle do Câncer de Cabeça e Pescoço', tags: ['oncologia','otorrinolaringologia','cirurgia'] },
  ...
  // Agosto
  { month: 8, day: 1,  label: 'Agosto Dourado — Aleitamento Materno', tags: ['pediatria','ginecologia','nutrologia','obstetrícia'] },
  { month: 8, day: 9,  label: 'Dia Nacional de Combate ao Fumo', tags: ['pneumologia','cardiologia','oncologia','dermatologia'] },
  { month: 8, day: 10, label: 'Dia do Ótico (Saúde Auditiva)', tags: ['otorrinolaringologia','saúde pública'] },
  { month: 8, day: 13, label: 'Dia dos Pais', tags: ['saúde masculina','urologia','cardiologia','nutrição','bem-estar'] },
  { month: 8, day: 26, label: 'Dia Nacional de Doação de Órgãos', tags: ['cirurgia','saúde pública','nefrologia','cardiologia'] },
  // Setembro
  { month: 9, day: 7,  label: 'Setembro Amarelo — Prevenção ao Suicídio', tags: ['psiquiatria','psicologia','saúde mental','neurologia'] },
  { month: 9, day: 10, label: 'Dia Mundial de Prevenção ao Suicídio', tags: ['psiquiatria','saúde mental','neurologia'] },
  { month: 9, day: 15, label: 'Dia Nacional de Combate ao Colesterol', tags: ['cardiologia','nutrição','endocrinologia','clínica médica'] },
  { month: 9, day: 21, label: 'Dia Mundial do Alzheimer', tags: ['neurologia','geriatria','psiquiatria','nutrição'] },
  { month: 9, day: 22, label: 'Início da Primavera', tags: ['dermatologia','alergologia','nutrição','oftalmologia'] },
  { month: 9, day: 26, label: 'Dia Nacional de Prevenção e Controle do Câncer de Tireoide', tags: ['endocrinologia','oncologia','cirurgia'] },
  { month: 9, day: 29, label: 'Dia Mundial do Coração', tags: ['cardiologia','clínica médica','nutrição','medicina esportiva'] },
  // Outubro
  { month: 10, day: 1,  label: 'Dia Internacional do Idoso', tags: ['geriatria','cardiologia','ortopedia','nutrição','neurologia'] },
  { month: 10, day: 2,  label: 'Outubro Rosa — Câncer de Mama', tags: ['mastologia','ginecologia','oncologia','dermatologia','nutrição'] },
  { month: 10, day: 10, label: 'Dia Mundial da Saúde Mental', tags: ['psiquiatria','psicologia','saúde mental','neurologia'] },
  { month: 10, day: 12, label: 'Dia das Crianças', tags: ['pediatria','nutrição','dermatologia','odontologia'] },
  { month: 10, day: 15, label: 'Dia do Médico', tags: ['todos os especialistas','branding médico','marketing médico'] },
  { month: 10, day: 16, label: 'Dia Mundial da Alimentação', tags: ['nutrologia','nutrição','endocrinologia','gastroenterologia'] },
  { month: 10, day: 20, label: 'Dia Mundial da Osteoporose', tags: ['ortopedia','reumatologia','endocrinologia','nutrição'] },
  { month: 10, day: 29, label: 'Dia Mundial do AVC', tags: ['neurologia','cardiologia','clínica médica','fisioterapia'] },
  { month: 10, day: 31, label: 'Halloween (Tendências de beleza e pele)', tags: ['dermatologia','cirurgia plástica','estética'] },
  // Novembro
  { month: 11, day: 1,  label: 'Novembro Azul — Saúde Masculina e Próstata', tags: ['urologia','andrologia','cardiologia','saúde masculina','oncologia'] },
  { month: 11, day: 14, label: 'Dia Mundial do Diabetes', tags: ['endocrinologia','nutrologia','nutrição','clínica médica','oftalmologia'] },
  { month: 11, day: 15, label: 'Dia da Proclamação da República (Reflexão sobre Saúde Pública)', tags: ['saúde pública','medicina preventiva'] },
  { month: 11, day: 17, label: 'Dia Nacional do Prematuro', tags: ['pediatria','neonatologia','obstetrícia','nutrição'] },
  { month: 11, day: 20, label: 'Dia da Consciência Negra (Saúde da População Negra)', tags: ['dermatologia','saúde pública','hematologia','nutrição'] },
  { month: 11, day: 25, label: 'Dia Internacional de Eliminação da Violência contra a Mulher', tags: ['saúde feminina','psiquiatria','psicologia','saúde pública'] },
  { month: 11, day: 29, label: 'Black Friday (Procedimentos Estéticos e Bem-estar)', tags: ['dermatologia','cirurgia plástica','estética','odontologia'] },
  // Dezembro
  { month: 12, day: 1,  label: 'Dia Mundial de Combate à AIDS (Dezembro Vermelho)', tags: ['infectologia','ginecologia','saúde sexual','dermatologia','urologia'] },
  { month: 12, day: 3,  label: 'Dia Internacional das Pessoas com Deficiência', tags: ['ortopedia','neurologia','fisioterapia','saúde pública'] },
  { month: 12, day: 9,  label: 'Dia Nacional de Combate à Corrupção (Transparência em Saúde)', tags: ['saúde pública','marketing médico'] },
  { month: 12, day: 21, label: 'Início do Verão', tags: ['dermatologia','fotoproteção','nutrição','cirurgia plástica','estética'] },
  { month: 12, day: 25, label: 'Natal (Bem-estar e Alimentação nas Festas)', tags: ['nutrologia','nutrição','endocrinologia','saúde mental','bem-estar','dermatologia'] },
  { month: 12, day: 31, label: 'Réveillon (Metas de Saúde para o Novo Ano)', tags: ['bem-estar','saúde mental','nutrologia','dermatologia','medicina esportiva','endocrinologia'] },
];
